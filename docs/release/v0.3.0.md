...
5. Verify the tagged run uploads:
...
6. Publish only after the GitHub Release transitions from draft to non-draft and the runner output matches the expectations above.
